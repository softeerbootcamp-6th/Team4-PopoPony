...
INSERT INTO route_leg (
    id, route_id, leg_type, total_distance, total_time, total_fare, taxi_fare, used_favorite_route_vertices,
    created_at, updated_at
) VALUES
      (1, 1, 'MEETING_TO_HOSPITAL', 5200, 15, 3000, 15000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (2, 1, 'HOSPITAL_TO_RETURN', 11200, 30, 5000, 22000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

      (3, 2, 'MEETING_TO_HOSPITAL', 8900, 25, 4500, 20000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (4, 2, 'HOSPITAL_TO_RETURN', 5300, 15, 3200, 15000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

      (5, 3, 'MEETING_TO_HOSPITAL', 4700, 14, 3000, 14000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (6, 3, 'HOSPITAL_TO_RETURN', 9100, 27, 4800, 21000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

      (7, 4, 'MEETING_TO_HOSPITAL', 9600, 28, 5000, 22000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (8, 4, 'HOSPITAL_TO_RETURN', 4200, 12, 2800, 13000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

      (9, 5, 'MEETING_TO_HOSPITAL', 3700, 10, 2500, 12000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (10, 5, 'HOSPITAL_TO_RETURN', 6100, 17, 3500, 15000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
