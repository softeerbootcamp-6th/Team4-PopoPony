...
VALUES
    (1, 'user01', '$2a$12$Aq86sdOQfrFnzqPEW/eCteGwyxUL9Cl/Qya7w0.O7eYl9v0MnNvX2', '김민수', '1995-03-15', 'MALE', '010-1234-5678', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (2, 'user02', '$2a$12$Aq86sdOQfrFnzqPEW/eCteGwyxUL9Cl/Qya7w0.O7eYl9v0MnNvX2', '이서연', '1998-07-22', 'FEMALE', '010-2345-6789', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (3, 'user03', '$2a$12$Aq86sdOQfrFnzqPEW/eCteGwyxUL9Cl/Qya7w0.O7eYl9v0MnNvX2', '박지훈', '1992-11-30', 'MALE', '010-3456-7890', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (4, 'user04', '$2a$12$Aq86sdOQfrFnzqPEW/eCteGwyxUL9Cl/Qya7w0.O7eYl9v0MnNvX2', '최유진', '2000-01-10', 'FEMALE', '010-4567-8901', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (5, 'user05', '$2a$12$Aq86sdOQfrFnzqPEW/eCteGwyxUL9Cl/Qya7w0.O7eYl9v0MnNvX2', '정우성', '1989-05-05', 'MALE', '010-5678-9012', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (6, 'user06', '$2a$12$Aq86sdOQfrFnzqPEW/eCteGwyxUL9Cl/Qya7w0.O7eYl9v0MnNvX2', '한지민', '1993-09-08', 'FEMALE', '010-6789-0123', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

ALTER TABLE auth ALTER COLUMN id RESTART WITH 7;


INSERT INTO image_file (id, s3_key, content_type, size_bytes, checksum, created_at, updated_at)
VALUES (1, 'uploads/patient/33ea86d5-2cf7-463c-ab87-3e01c5cc45bd.png', 'image/png', 0, 'e1', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (2, 'uploads/patient/2317063e-39c2-4cef-9950-32b5b7db6368.png', 'image/png', 0, 'e2', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (3, 'uploads/patient/bd47cd02-52e2-4e6f-bd4c-b854f184d5b1.png', 'image/png', 0, 'e3', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (4, 'uploads/patient/780dc135-b884-4524-a002-f31fd180882d.png', 'image/png', 0, 'e4', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (5, 'uploads/patient/8dd57eba-8c9a-48b9-8757-98de2ffd5c3c.png', 'image/png', 0, 'e5', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (6, 'uploads/certificate/570435b2-1579-4a72-b1fb-ff70523e40f8.png', 'image/png', 0, 'e1', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (7, 'uploads/certificate/570435b2-1579-4a72-b1fb-ff70523e40f8.png', 'image/png', 0, 'e2', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (8, 'uploads/certificate/570435b2-1579-4a72-b1fb-ff70523e40f8.png', 'image/png', 0, 'e3', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (9, 'uploads/certificate/570435b2-1579-4a72-b1fb-ff70523e40f8.png', 'image/png', 0, 'e4', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (10, 'uploads/certificate/570435b2-1579-4a72-b1fb-ff70523e40f8.png', 'image/png', 0, 'e5', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (11, 'uploads/certificate/570435b2-1579-4a72-b1fb-ff70523e40f8.png', 'image/png', 0, 'e6', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (12, 'uploads/certificate/570435b2-1579-4a72-b1fb-ff70523e40f8.png', 'image/png', 0, 'e7', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (101, 'uploads/taxi/0c75237c-2d6d-4f02-aa15-70426c6fd449.png', 'image/png', 102400, '"etag-dep-1"', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (102, 'uploads/taxi/0c75237c-2d6d-4f02-aa15-70426c6fd449.png', 'image/png', 204800, '"etag-ret-1"', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (103, 'uploads/taxi/0c75237c-2d6d-4f02-aa15-70426c6fd449.png', 'image/png', 102400, '"etag-dep-2"', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (104, 'uploads/taxi/0c75237c-2d6d-4f02-aa15-70426c6fd449.png', 'image/png', 204800, '"etag-ret-2"', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (105, 'uploads/taxi/0c75237c-2d6d-4f02-aa15-70426c6fd449.png', 'image/png', 102400, '"etag-dep-3"', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (106, 'uploads/taxi/0c75237c-2d6d-4f02-aa15-70426c6fd449.png', 'image/png', 204800, '"etag-ret-3"', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (107, 'uploads/taxi/0c75237c-2d6d-4f02-aa15-70426c6fd449.png', 'image/png', 102400, '"etag-dep-4"', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (108, 'uploads/taxi/0c75237c-2d6d-4f02-aa15-70426c6fd449.png', 'image/png', 204800, '"etag-ret-4"', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (109, 'uploads/taxi/0c75237c-2d6d-4f02-aa15-70426c6fd449.png', 'image/png', 102400, '"etag-dep-5"', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (110, 'uploads/taxi/0c75237c-2d6d-4f02-aa15-70426c6fd449.png', 'image/png', 204800, '"etag-ret-5"', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (111, 'uploads/taxi/0c75237c-2d6d-4f02-aa15-70426c6fd449.png', 'image/png', 102400, '"etag-dep-6"', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (112, 'uploads/taxi/0c75237c-2d6d-4f02-aa15-70426c6fd449.png', 'image/png', 204800, '"etag-ret-6"', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (113, 'uploads/taxi/0c75237c-2d6d-4f02-aa15-70426c6fd449.png', 'image/png', 102400, '"etag-dep-7"', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (114, 'uploads/taxi/0c75237c-2d6d-4f02-aa15-70426c6fd449.png', 'image/png', 204800, '"etag-ret-7"', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (201, 'uploads/report/59c6af32-38d8-4200-b72a-f59394751e1b.png', 'image/png', 123456, '"etag-p1"',  CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (202, 'uploads/report/aa7f95a4-8844-446a-a029-7bf41e0e373a.png', 'image/png', 234567, '"etag-p2"',  CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (203, 'uploads/report/59c6af32-38d8-4200-b72a-f59394751e1b.png', 'image/png', 111111, '"etag-21"',  CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (204, 'uploads/report/aa7f95a4-8844-446a-a029-7bf41e0e373a.png', 'image/png', 222222, '"etag-31"',  CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (205, 'uploads/report/59c6af32-38d8-4200-b72a-f59394751e1b.png', 'image/png', 333333, '"etag-32"',  CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (206, 'uploads/report/aa7f95a4-8844-446a-a029-7bf41e0e373a.png', 'image/png', 444444, '"etag-41"',  CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (207, 'uploads/report/59c6af32-38d8-4200-b72a-f59394751e1b.png', 'image/png', 555555, '"etag-51"',  CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (208, 'uploads/report/aa7f95a4-8844-446a-a029-7bf41e0e373a.png', 'image/png', 666666, '"etag-61"',  CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (209, 'uploads/report/59c6af32-38d8-4200-b72a-f59394751e1b.png', 'image/png', 777777, '"etag-62"',  CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (210, 'uploads/report/aa7f95a4-8844-446a-a029-7bf41e0e373a.png', 'image/png', 888888, '"etag-71"',  CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (211, 'uploads/helper/75057164-309e-40e6-a1d8-d66f69c0e5e5.png', 'image/png', 0, 'e1', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (212, 'uploads/helper/1e874e01-b5d3-423e-acfc-ea45953ff64d.png', 'image/png', 0, 'e2', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (213, 'uploads/helper/506e5072-468a-481b-86a4-6ed142293e7c.png', 'image/png', 0, 'e3', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (214, 'uploads/helper/b80cf275-8074-4662-980d-65547da18312.png', 'image/png', 0, 'e4', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (215, 'uploads/helper/1a672ac8-a37a-446d-9f9a-055241c4f0c6.png', 'image/png', 0, 'e5', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

ALTER TABLE image_file ALTER COLUMN id RESTART WITH 216;
...
INSERT INTO route_leg (
    id, total_distance, total_time, total_fare, taxi_fare, used_favorite_route_vertices,
    created_at, updated_at
) VALUES
      (1, 5200, 15, 3000, 15000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (2, 11200, 30, 5000, 22000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

      (3, 8900, 25, 4500, 20000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (4, 5300, 15, 3200, 15000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

      (5, 4700, 14, 3000, 14000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (6, 9100, 27, 4800, 21000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

      (7, 9600, 28, 5000, 22000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (8, 4200, 12, 2800, 13000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

      (9, 3700, 10, 2500, 12000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (10, 6100, 17, 3500, 15000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

ALTER TABLE route_leg ALTER COLUMN id RESTART WITH 11;


INSERT INTO route (
    id, meeting_location_info_id, hospital_location_info_id, return_location_info_id, meeting_to_hospital_id, hospital_to_return_id, created_at, updated_at
) VALUES
      (1, 1, 2, 3, 1, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (2, 2, 3, 4, 3, 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (3, 3, 4, 5, 5, 6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (4, 4, 5, 1, 7, 8, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (5, 5, 1, 2, 9, 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
ALTER TABLE recruit ALTER COLUMN id RESTART WITH 12;
...
INSERT INTO escort (
    ...
    created_at, updated_at
      ...
      (1, 1, 1, 1, '다음 진료 예약 잡았습니다.', 'DONE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (2, 2, 2, 3, '상태 많이 호전되셨어요.', 'WRITING_REPORT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (3, 3, 3, 4, '추가 검진 필요하다고 합니다.', 'DONE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (4, 4, 4, 2, '교통체증으로 복귀가 조금 늦었습니다.', 'WRITING_REPORT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (5, 5, 5, 1, '약 식후 30분에 드시면 됩니다.', 'DONE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (6, 6, 1, 5, '약 다른 걸로 바꿔야 한다고 하네요.', 'DONE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (7, 10, 5, 3, '주사 한 방 맞았습니다.', 'PREPARING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

      (8, 9, 4, 4, NULL, 'WRITING_REPORT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

      (9, 8, 3, 5, '혈압 전보다 낮아지셨습니다.', 'RETURNING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

      (10, 11, 2, 2, NULL, 'MEETING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

ALTER TABLE escort ALTER COLUMN id RESTART WITH 11;
