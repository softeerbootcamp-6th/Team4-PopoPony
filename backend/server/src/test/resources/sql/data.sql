...
INSERT INTO report (
    ...
    created_at, updated_at, deleted_at
      ...
      (1, 1, 1, 1,  FALSE, NULL, '예정된 시간에 잘 만났고, 병원 진료도 원활히 진행되었습니다.', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, null),

      (2, 2, 2, 3,  TRUE, '2025-09-01 10:30:00', '다음 정기 검진 일정이 있어 재방문 예정입니다.', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, null),

      (3, 3, 3, 4,  FALSE, NULL, '재활 치료는 문제없이 마무리되었고, 환자 만족도 높았습니다.', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, null),

      (4, 4, 4, 2,  FALSE, NULL, '환자와 대화가 잘 되었고 요청 사항도 잘 반영되었습니다.', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, null),

      (5, 5, 5, 1, TRUE, '2025-08-20 14:00:00', '다음 진료가 예약되어 있으며, 동일 도우미 요청 예정입니다.', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, null),

      (6, 6, 1, 5, FALSE, NULL, '고령 환자였으나 무리 없이 동행 마무리.', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, null),

      (7, 10, 5, 3, TRUE, '2025-08-30 10:00:00', '날씨가 좋지 않아 외부 이동에 유의 필요. 환자 상태 양호.', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, null);
