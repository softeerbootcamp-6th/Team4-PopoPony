...
const WritingReport = () => {
  return (
    <div className='p-[2rem]'>
      <h4 className='headline-24-bold text-text-neutral-primary mt-[4rem]'>
        무사히 복귀를 완료했어요!
      </h4>
      <p className='body1-16-medium text-text-neutral-secondary mt-[0.8rem]'>
        {`도우미가 리포트 작성중이예요.\n최대 3시간까지 소요될 수 있어요.`}
      </p>
      ...
      <div className='bg-background-light-red flex flex-col gap-[0.8rem] rounded-[0.6rem] px-[1.2rem] py-[1rem]'>
